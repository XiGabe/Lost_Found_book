...
from models.siamese_lstm import SiameseBiLSTM
...
def main():
    ...
    parser.add_argument('--checkpoint', type=str,
                        default='logic/outputs/run_/best_comparator.pth',
                        help='模型检查点路径')
    ...
    # 批量推理
        ...
        print('  python inference.py --batch-file logic/lcc_training_data.csv')
