...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'large_models_examples', 'function_calling','smart_factory'), glob(os.path.join('large_models_examples', 'function_calling','smart_factory', '*.*'))),
    ...
    entry_points={
        'console_scripts': [
            ...
            'smart_factory = large_models_examples.function_calling.smart_factory.smart_factory:main',
            'smart_factory_transport_node = large_models_examples.function_calling.smart_factory.smart_factory_transport_node:main',
