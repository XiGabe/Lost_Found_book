...
import numpy as np
from sdk import pid
target_lib = "/home/ubuntu/.local/lib/python3.10/site-packages/open3d/cuda/libOpen3D.so.0.19"
if target_lib not in os.environ.get("LD_PRELOAD", ""):
    os.environ["LD_PRELOAD"] = target_lib + ":" + os.environ.get("LD_PRELOAD", "")
